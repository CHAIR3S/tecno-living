    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card border-t border-b border-border overflow-hidden">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="testimonials-scroll">
          {/* Single continuous set that loops infinitely */}
          {[...TESTIMONIALS, ...TESTIMONIALS].map((testimonial, index) => (
            <div
              key={`${testimonial.id}-${index}`}
              className="flex-shrink-0 w-80 bg-background rounded-lg border border-border p-6 shadow-sm hover:shadow-md transition-shadow"
            >
